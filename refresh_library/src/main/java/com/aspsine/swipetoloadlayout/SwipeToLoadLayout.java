...
public class SwipeToLoadLayout extends ViewGroup {
    ...
    private OnBothRefreshListener mBothRefreshListener;
    ...
    public void setOnBothRefreshListener(OnBothRefreshListener mBothRefreshListener) {
        this.mBothRefreshListener = mBothRefreshListener;
    }
    ...
    RefreshCallback mRefreshCallback = new RefreshCallback() {
        ...
        public void onRefresh() {
            if (mHeaderView != null && STATUS.isRefreshing(mStatus)) {
                ...
                if( mBothRefreshListener != null){
                    mBothRefreshListener.onRefresh();
                }
            }
        }
    ...
    LoadMoreCallback mLoadMoreCallback = new LoadMoreCallback() {
        ...
        public void onLoadMore() {
            if (mFooterView != null && STATUS.isLoadingMore(mStatus)) {
                ...
                if(mBothRefreshListener != null){
                    mBothRefreshListener.onLoadMore();
                }
            }
        }
